...
export default function AdminDashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      // On vérifie chaque réponse individuellement pour éviter que l'échec d'une ne bloque les autres
    ...
    <div className="p-6 space-y-10 bg-gray-50 min-h-screen">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          {/* Le composant ResponsiveContainer ajuste automatiquement la taille du graphique à son conteneur */}
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={sales}>
              <CartesianGrid
                ...
                stroke="#f0f0f0"
              />
              {/* Configuration des axes pour un look épuré */}
              <XAxis
                dataKey="date"
                axisLine={false}
                tickLine={false}
              ...
              />
              {/* Configuration de l'axe Y pour un look épuré */}
              <YAxis
                axisLine={false}
                tickLine={false}
                tick={{ fill: "#9ca3af", fontSize: 11 }}
              />
              {/* Configuration du tooltip pour un look épuré */}
              <Tooltip
                contentStyle={{
                  borderRadius: "12px",
                  border: "none",
              ...
              />
              {/* Configuration de la ligne pour un look épuré */}
              <Line
                type="monotone"
                dataKey="total"
                stroke="#6366f1"
              ...
              lowStock.map((p) => (
                ...
                >
                  <div className="flex flex-col">
                    <span className="text-sm font-bold text-gray-800 truncate w-28">
                      {p.name}
                    </span>

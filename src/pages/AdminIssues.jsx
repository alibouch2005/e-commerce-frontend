...
export default function AdminIssues() {
  ...
  const risks = useMemo(() => [
    ...
    { id: "paid-cancelled", title: "Commandes payées puis annulées", count: attention.paid_cancelled_orders, severity: "critical", icon: CreditCard, to: "/admin/orders", action: "Traiter le remboursement", detail: "Le paiement a été encaissé mais la commande est annulée. Vérifiez et exécutez le remboursement chez CMI avant de clôturer le dossier." },
  ...
  ], [attention.at_risk_customers, attention.failed_card_payments, attention.flagged_customers, attention.low_stock, attention.open_product_requests, attention.open_support, attention.out_of_stock, attention.overdue_pending_orders, attention.paid_cancelled_orders, attention.pending_cash_amount_cents, attention.pending_cash_collections, attention.refunds, attention.stale_card_payments, attention.stale_delivery_offers, attention.unassigned_shipping, attention.urgent_support]);
